...
func TestClimateLevel4(t *testing.T) {
	...
	globalPlacement, err := e.PlaceDevices(apartmentStruct, map[string]string{"climate": "4"})
	assert.NoError(t, err)

	assert.True(t, globalPlacement.HasDeviceInRoom("smart_floor_thermostat", "r3"))
	assert.True(t, globalPlacement.HasDeviceInRoom("smart_floor_thermostat", "r5"))
	assert.True(t, globalPlacement.HasDeviceInRoom("floor_temperature_sensor", "r3"))
	assert.True(t, globalPlacement.HasDeviceInRoom("floor_temperature_sensor", "r5"))
}
