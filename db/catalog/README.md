...
Этот мотор для штор можно пробросить в умный дом яндекса, если подключили его в aqara home через aqara hub - больше ничего не нужно, потому что это облачная интеграция, протокол cloud
