...
**Temporal UI** (порт 8080) — основной инструмент для наблюдения за workflow: видно историю запусков, статус каждого activity, логи ошибок и ретраев.
...
**Метрики** — каждый сервис экспортирует Prometheus-метрики на стандартном порту.
