...
class DeviceTypeInfo:
    def __init__(self, name: str, description: str, preprocessed_schema: JsonSchema):
        self.name = name
...
class OutlinesExtractor:
    def __init__(self, taxonomy: dict[str, Any], model: Any):
        """
...
{self._device_type_field_descriptions[type_info.name]}
