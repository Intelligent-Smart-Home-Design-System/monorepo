...
func TestClimateLevel5(t *testing.T) {
	apartmentStruct := &apartment.Apartment{
		...
		Rooms: []apartment.Room{
			{ID: "r1", Name: apartment.RoomLiving, AreaM2: 16, Area: []point.Point{{X: 0, Y: 0}, {X: 4, Y: 0}, {X: 4, Y: 4}, {X: 0, Y: 4}}, Walls: []string{"w1", "w2", "w3", "w4"}},
			{ID: "r2", Name: apartment.RoomBedroom, AreaM2: 16, Area: []point.Point{{X: 5, Y: 0}, {X: 9, Y: 0}, {X: 9, Y: 4}, {X: 5, Y: 4}}, Walls: []string{"w5", "w6", "w7", "w8"}},
			{ID: "r3", Name: apartment.RoomKitchen, AreaM2: 16, Area: []point.Point{{X: 0, Y: 5}, {X: 4, Y: 5}, {X: 4, Y: 9}, {X: 0, Y: 9}}, Walls: []string{"w9", "w10", "w11", "w12"}},
			{ID: "r4", Name: apartment.RoomCabinet, AreaM2: 16, Area: []point.Point{{X: 5, Y: 5}, {X: 9, Y: 5}, {X: 9, Y: 9}, {X: 5, Y: 9}}, Walls: []string{"w13", "w14", "w15", "w16"}},
			{ID: "r5", Name: apartment.RoomBathroom, AreaM2: 16, Area: []point.Point{{X: 10, Y: 0}, {X: 14, Y: 0}, {X: 14, Y: 4}, {X: 10, Y: 4}}, Walls: []string{"w17", "w18", "w19", "w20"}},
		},
	}
