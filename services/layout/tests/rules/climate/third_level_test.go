...
func TestClimateLevel3(t *testing.T) {
	...
	apartmentStruct := &apartment.Apartment{
		...
		Rooms: []apartment.Room{
			{ID: "r1", Name: apartment.RoomLiving, AreaM2: 16, Area: []point.Point{{X: 0, Y: 0}, {X: 4000, Y: 0}, {X: 4000, Y: 4000}, {X: 0, Y: 4000}}, Walls: []string{"w1", "w2", "w3", "w4"}, Windows: []string{"win1"}},
	...
	globalPlacement, err := e.PlaceDevices(apartmentStruct, map[string]string{"climate": "3"}, nil)
